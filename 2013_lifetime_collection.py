...
sheet=excel.active
sheet.title='2012_boxoffice_collection'
...
url = "https://www.bollywoodhungama.com/box-office-collections/filterbycountry/IND/2012/"
...
for list in newlist:
     ...
     excel.save('2012_boxoffice_collection.xlsx')
