...
sheet=excel.active
sheet.title='2010_boxoffice_collection'
...
url = "https://www.bollywoodhungama.com/box-office-collections/filterbycountry/IND/2010/"
...
for list in newlist:
     ...
     excel.save('2010_boxoffice_collection.xlsx')
