...
sheet=excel.active
sheet.title='2016_boxoffice_collection'
...
url = "https://www.bollywoodhungama.com/box-office-collections/filterbycountry/IND/2016/"
...
for list in newlist:
     ...
     excel.save('2016_boxoffice_collection.xlsx')
