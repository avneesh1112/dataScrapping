...
sheet=excel.active
sheet.title='2019_boxoffice_collection'
sheet.append(['Movie_name','Release_Date','Opening_Day','Opening_Weekend','End_of_week_1','lifetime'])

url = "https://www.bollywoodhungama.com/box-office-collections/filterbycountry/IND/2019"
...
for list in newlist:
     ...
     sheet.append([Movie_name,Release_date,Opening_Day,Opening_Weekend,End_of_week_1,lifetime])
     excel.save('2019_boxoffice_collection.xlsx')
