...
sheet=excel.active
sheet.title='2014_boxoffice_collection'
...
url = "https://www.bollywoodhungama.com/box-office-collections/filterbycountry/IND/2014/"
...
for list in newlist:
     ...
     excel.save('2014_boxoffice_collection.xlsx')
