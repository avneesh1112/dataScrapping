...
sheet=excel.active
sheet.title='2011_boxoffice_collection'
...
url = "https://www.bollywoodhungama.com/box-office-collections/filterbycountry/IND/2011/"
...
for list in newlist:
     ...
     excel.save('2011_boxoffice_collection.xlsx')
