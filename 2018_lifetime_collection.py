...
sheet=excel.active
sheet.title='2017_boxoffice_collection'
...
url = "https://www.bollywoodhungama.com/box-office-collections/filterbycountry/IND/2017"
...
for list in newlist:
     ...
     excel.save('2017_boxoffice_collection.xlsx')
