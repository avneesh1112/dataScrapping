...
sheet=excel.active
sheet.title='2013_boxoffice_collection'
...
url = "https://www.bollywoodhungama.com/box-office-collections/filterbycountry/IND/2013/"
...
for list in newlist:
     ...
     excel.save('2013_boxoffice_collection.xlsx')
